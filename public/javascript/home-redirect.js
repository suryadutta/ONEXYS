...
$('.ic-app-header__logomark').css("background-image", "url(https://github.com/UVAMobileDev/ONEXYS/blob/master/public/images/logo/institutionIcon.png?raw=true");$('.ic-app-header__logomark').css("background-color", "white");  
