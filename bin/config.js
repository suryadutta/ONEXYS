...
config.mongoURLs = {
    '2517' : 'mongodb://'+config.mongo_username+':'+config.mongo_password+'@onexys-shard-00-00-qkreu.mongodb.net:27017,onexys-shard-00-01-qkreu.mongodb.net:27017,onexys-shard-00-02-qkreu.mongodb.net:27017/test?ssl=true&replicaSet=ONEXYS-shard-0&authSource=admin&retryWrites=true' || config.local_mongo_database,
