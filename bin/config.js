...
config.mongoURLs = {
    '2517' : 'mongodb+srv://'+config.mongo_username+':'+config.mongo_password+'@onexys-shard-00-00-qkreu.mongodb.net/test?ssl=true&replicaSet=ONEXYS-shard-0&authSource=admin&retryWrites=true' || config.local_mongo_database,
